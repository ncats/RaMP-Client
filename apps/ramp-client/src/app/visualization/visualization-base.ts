  ...
  setMinMax(): void {
    if (this.data != null && this.dataXKey != null && this.dataYKey != null) {
      ...
      this.data.forEach((item) => {
        if (this.dataXKey && typeof item[this.dataXKey] === 'number') {
          xVector.push(item[this.dataXKey]);
        }
        if (this.dataYKey && typeof item[this.dataYKey] === 'number') {
      ...
      if (xVector.length > 0) {
        ...
        const xPadding = xRange.times(0.1);
      ...
      if (yVector.length > 0) {
        ...
        const yPadding = yRange.times(0.1);
